...
- Conclusão: a única falha observada foi na implementação manual; a biblioteca detectou todos os padrões inseridos.
...
- Divergência manual vs. biblioteca: os falsos negativos indicam que a rotina manual não está alinhada com o polinômio/offset do CRC16.MODBUS (ou há bug no cálculo). Mesmo assim, a biblioteca marcou todos os quadros corrompidos.
- Implicação: transmissor e verificador precisam usar exatamente o mesmo polinômio e convenções; qualquer discrepância pode deixar passar erros.
